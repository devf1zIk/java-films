...
public class UserController {
    ...
    @GetMapping("/{id}/friend/common/{friendId}")
    public List<User> getFriendsCommon(@PathVariable int id, @PathVariable int friendId) {
        return userService.getCommon(id,friendId);
    }
}
